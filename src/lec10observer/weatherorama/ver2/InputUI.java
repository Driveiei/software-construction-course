...
public class InputUI {
    ...
    public void receive(WeatherData weatherData, OceanData oceanData, PollutionData pollution) {
        ...
        while (true) {
            ...
            double pm = Double.parseDouble(in.nextLine());
            pollution.setPmValue(pm);
        }
    }
}
